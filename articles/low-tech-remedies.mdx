...
imageAlt: A young man grinds ingredients with a mortar and pestle in a rustic apothecary, surrounded by herbs, glass jars of amber liquid, bottles, a candle, and an open botanical book on the table.
...
<Img src="alchemist.jpg" float="right" alt="A young man grinds ingredients with a mortar and pestle in a rustic apothecary, surrounded by herbs, glass jars of amber liquid, bottles, a candle, and an open botanical book on the table." />
...
<Img src="alcohol.jpg" float="left" alt="A cut crystal tumbler holding amber whisky sits on wooden table." />
...
<Img src="honey-filtration.jpg" float="right" alt="Honey pours from the spigot of a stainless steel extractor into a fine mesh strainer below to filter it." />
...
Two cautions. Raw honey can carry botulism spores; these pose essentially no risk on an adult's wound but must never be eaten by an infant under one year old, in whom they can cause infant botulism. (Medical-grade honey is irradiated to kill these.) Heat destroys the active enzymes, do not boil honey if you want it to work as an antiseptic.

### Garlic

<Img src="garlic.jpg" float="left" alt="A braid of whole garlic bulbs hangs by their dried, braided stalks." />
...
The sticky sap of pine and related conifers is antimicrobial and was traditionally used to seal and protect wounds. Its resin acids inhibit many bacteria and fungi by disrupting their cell membranes, and physically the salve forms a sticky, water-resistant film that helps keep new contaminants out.
...
<Img src="sphagnum-moss.jpg" float="left" alt="A pile of pine resin chunks in varied amber, reddish-brown, and pale honey tones." />
...
**Usage:** use the cleanest available moss (boil and dry it if you can), and pack it over a base dressing (direct contact with raw moss can introduce a fungal infection called sporotrichosis) to soak up discharge from a wound. It is a dressing material, not a cure.

## Controlling Bleeding

### Yarrow "Soldier's Woundwort"

<Img src="yarrow.jpg" float="right" alt="A flat-topped cluster of small white yarrow flowers with pale yellow centers." />
...
**Usage:** the leaves are the part used. Crushed or chewed into a poultice, they soothes irritated skin and is the traditional "drawing" remedy: pressed over irritated skin or a minor infection, it eases the swelling by reducing histamine release and has a modest antimicrobial properties. It is gentle enough to use freely on the skin.

### Comfrey "Knitbone"

<Img src="comfrey.jpg" float="right" alt="Clusters of bell-shaped purple comfrey flowers droop above broad green leaves." />
...
**Usage:** the leaves and root are both used, but prefer the leaves — the root is far richer in the toxic alkaloids. Crush them into a poultice, or work them into a salve, and apply over a closed injury such as a sprain or bruise.

### Aloe

<Img src="aloe.jpg" float="left" alt="An aloe vera plant with thick, spiky-edged green leaves grows in a terracotta pot." />

The clear gel from inside the leaf is soothing and anti-inflammatory, calming irritated skin and easing the sting of a burn. Use only that clear inner gel; the bitter yellow juice (latex) just beneath the rind is a harsh skin irritant and a strong purgative, so scrape it away. Heat destroys aloe's active compounds, so it must be used fresh from the leaf, not cooked into anything.
...
<Img src="white-willow.jpg" float="left" alt="A white willow branch with thin green leaves and fluffy white seed catkins." />
...
**Caution:** because willow bark works like aspirin, it carries aspirin's risks. Don't give it to children or teenagers with a fever or viral illness, due to the risk of a rare but life-threatening liver-and-brain condition (Reye's syndrome). Anyone allergic or sensitive to aspirin must avoid it.

### Cloves

<Img src="cloves.jpg" float="right" alt="A pile of whole dried cloves with reddish-brown nail-shaped buds and stems." />
...
**Usage:** the clove itself is the dried flower bud. Bite gently on a whole clove next to the painful tooth, or dab a small amount of diluted clove oil on it for real numbing relief. Clove oil is potent — dilute it in a little carrier oil, keep it to the affected tooth, and don't flood the gum, since undiluted oil can burn the soft tissue. Avoid swallowing large quantities, as eugenol is toxic in excess (especially to children).
...
<Categorize words="willow bark;yarrow;cloves;honey;comfrey;sphagnum moss;aloe;strong alcohol">
  ...
  <Category label="Reducing swelling and inflammation" answer="comfrey;aloe" />
...
<Choices>
  ...
  <Choice explanation="Wine and ale are only about 5–14% alcohol — far too weak to disinfect. Even ordinary 40% spirits are merely usable in a pinch; non-distilled drinks won't sterilize a blade.">Wipe with table wine or ale.</Choice>
  <Choice explanation="Honey is antimicrobial, but far too slow-acting to sterilize a blade.">Wipe with honey.</Choice>
...
<Choices single>
  ...
  <Choice explanation="Raw garlic is more likely to cause chemical burns the longer it sits on skin. But boiling it would stop it working in the first place.">Because raw garlic is less likely to cause chemical burns.</Choice>
</Choices>
...
<Choices single>
  ...
  <Choice correct explanation="Flushing with plenty of clean, boiled-then-cooled water removes the dirt and bacteria that no poultice can fix.">Flush it thoroughly with clean water.</Choice>
