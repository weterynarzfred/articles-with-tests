...
<Img src="./fox.jpg" alt="A red fox resting on a large rock with eyes closed and head tilted upward, appearing content and relaxed, with a blurred snowy background." />
...
<ChoiceSet>
  ...
  3. Which of the following best describes where foxes typically live?
  <Choices single>
    <Choice>Only in dense rainforests</Choice>
    <Choice>Only in Arctic tundra</Choice>
    <Choice>Only in deserts</Choice>
    <Choice>A wide range of habitats far from human settlements</Choice>
    <Choice correct explanation="Foxes are highly adaptable and are found on every continent except Antarctica, thriving in wildly different environments – including urban areas.">A wide range of habitats, including forests, grasslands, and cities</Choice>
  </Choices>
</ChoiceSet>